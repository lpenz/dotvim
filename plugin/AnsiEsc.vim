...
"  call Dfunc("AnsiEsc#AnsiEsc()")
  ...
  if &t_Co == 8
    ...
    hi ansiBlinkBlack        ctermfg=black      guifg=black                                        cterm=underline    gui=underline
    hi ansiBlinkRed          ctermfg=red        guifg=red                                          cterm=underline    gui=underline
    hi ansiBlinkGreen        ctermfg=green      guifg=green                                        cterm=underline    gui=underline
    hi ansiBlinkYellow       ctermfg=yellow     guifg=yellow                                       cterm=underline    gui=underline
    hi ansiBlinkBlue         ctermfg=blue       guifg=blue                                         cterm=underline    gui=underline
    hi ansiBlinkMagenta      ctermfg=magenta    guifg=magenta                                      cterm=underline    gui=underline
    hi ansiBlinkCyan         ctermfg=cyan       guifg=cyan                                         cterm=underline    gui=underline
    hi ansiBlinkWhite        ctermfg=white      guifg=white                                        cterm=underline    gui=underline
    ...
    hi ansiYellowMagenta     ctermfg=yellow     ctermbg=magenta    guifg=Red        guibg=Magenta  cterm=none         gui=none
    hi ansiBlueMagenta       ctermfg=blue       ctermbg=magenta    guifg=Red        guibg=Magenta  cterm=none         gui=none
   ...
   " -------------------------
    ...
    hi ansiBlinkBlack        ctermfg=black      guifg=black                                        cterm=undercurl    gui=undercurl
    hi ansiBlinkRed          ctermfg=red        guifg=red                                          cterm=undercurl    gui=undercurl
    hi ansiBlinkGreen        ctermfg=green      guifg=green                                        cterm=undercurl    gui=undercurl
    hi ansiBlinkYellow       ctermfg=yellow     guifg=yellow                                       cterm=undercurl    gui=undercurl
    hi ansiBlinkBlue         ctermfg=blue       guifg=blue                                         cterm=undercurl    gui=undercurl
    hi ansiBlinkMagenta      ctermfg=magenta    guifg=magenta                                      cterm=undercurl    gui=undercurl
    hi ansiBlinkCyan         ctermfg=cyan       guifg=cyan                                         cterm=undercurl    gui=undercurl
    hi ansiBlinkWhite        ctermfg=white      guifg=white                                        cterm=undercurl    gui=undercurl
