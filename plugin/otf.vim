...
"	\version	$Id: otf.vim,v 1.1.1.1 2004/04/05 16:36:31 lpenz Exp $
"	Version:	0.21
"	History:	{{{
...
highlight default feralotf1 ctermfg=white ctermbg=red     guifg=white guibg=red
highlight default feralotf2 ctermfg=white ctermbg=green   guifg=black guibg=yellow
highlight default feralotf3 ctermfg=white ctermbg=blue    guifg=white guibg=blue
highlight default feralotf4 ctermfg=black ctermbg=green   guifg=black guibg=green
highlight default feralotf5 ctermfg=white ctermbg=magenta guifg=white guibg=magenta
highlight default feralotf6 ctermfg=black ctermbg=cyan    guifg=black guibg=cyan
highlight default feralotf7 ctermfg=black ctermbg=gray    guifg=black guibg=gray
highlight default feralotf8 ctermfg=white ctermbg=brown   guifg=white guibg=brown
" }}}
